...
int main()
{
    ...
    PLB_DAC_mWriteReg(XPAR_PLB_DAC_0_BASEADDR, PLB_DAC_SLV_REG0_OFFSET, 0x80000000);
    for (delay_cnt = 0; delay_cnt < 10; delay_cnt++) ;

    PLB_DAC_mWriteReg(XPAR_PLB_DAC_0_BASEADDR, PLB_DAC_SLV_REG0_OFFSET, 0xffffffff);
    for (delay_cnt = 0; delay_cnt < 10; delay_cnt++) ;
    ...
    PLB_DAC_mWriteReg(XPAR_PLB_DAC_0_BASEADDR, PLB_DAC_SLV_REG1_OFFSET, 0xaaaa5555);
    for (delay_cnt = 0; delay_cnt < 10; delay_cnt++) ;
