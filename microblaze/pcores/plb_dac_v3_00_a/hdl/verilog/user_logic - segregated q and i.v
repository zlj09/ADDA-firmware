...
//----------------------------------------------------------------------------
  ...
  wire       [9 : 0]                        saw_data;
  wire       [9 : 0]                        sine_data;
  wire       [PHASE_WIDTH-1 : 0]            phase_out_q;
  wire       [PHASE_WIDTH-1 : 0]            phase_out_i;
  wire       [PHASE_WIDTH-1 : 0]            step_ctl_q;
  wire       [PHASE_WIDTH-1 : 0]            step_ctl_i;
  ...
  assign step_ctl = slv_reg0[0 : 15];

  assign rect_data = (phase_out < 16'h8000_0000) ? (10'h3ff) : (10'h0);
  assign saw_data = phase_out[9 : 0];
