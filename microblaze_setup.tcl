...
#
#  File     microblaze_setup.tcl (Thu Aug 17 19:28:12 2017)
#
...
#  with the '-tclbatch microblaze_setup.tcl' option.
...
proc PrintHelpInformation {} {
  ...
  puts "**********************************************************************"
  puts "***"
  puts "***   Simulation Setup Macros (microblaze_setup.tcl)"
  puts "***"
  puts "***   w   =>  set up signal tracing for the ISE Simulator waveform"
  puts "***           viewer (edit signal lists in microblaze_wave.tcl)"
  puts "***"
